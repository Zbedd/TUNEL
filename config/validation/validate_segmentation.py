...
input_folder  = Path("G:/My Drive/KatzLab/TUNEL staining/TUNEL Second Third Datasets Merged/Raw nd2 Images/")
mask_folder  =  Path("G:/My Drive/KatzLab/TUNEL staining/TUNEL Second Third Datasets Merged/nd2 masks/")
kernel_size   = 51
